...
namespace WinForm
{
    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            InitializeComponent();
            this.Text = "订单管理";
            myOrderService.myList.Add(new OrderDetails("20181005001", "John", "Apple", 2.5, 3));
            myOrderService.myList.Add(new OrderDetails("20181005002", "Lily", "Orange", 2.7, 6));
        ...
        {
            //myOrderService.searchOrder(this.searchBy.Text, KeyWord);
            //reFresh();
            //for(int i=0;i<myOrderService.searchList.Count;i++)
            //{
            //    myOrderService.myList.Add(myOrderService.searchList[i]);
            //}
